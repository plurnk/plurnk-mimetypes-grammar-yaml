...
const work = await mkdtemp(path.join(tmpdir(), "grammar-yaml-verify-"));
await run("git", ["clone", "--no-checkout", "https://github.com/tree-sitter-grammars/tree-sitter-yaml.git", "src"], { cwd: work });
